...
Openshift AWS Quickstart

NOTE: Running complex deploys on docker for mac or minikube will make your laptop hot and slow. 

* Images

These yaml are set to pull from ```splunk/splunk:latest```. Ensure to update the image location if you are pulling from a different repo. 

* Namespace

This deployment assumes you are deploying to a namespace called ```splunk```. If you would like to change the namespace, you can update the kubectl commands or update the yamls to include the namespace. 


### NGINX

Nginx will be used to host our defaults.yml and our license. 

Place your default.yml file and license in ../nginx/nginx-www-data. It should look something like this: 
...
-rw-r--r--  1 mmodestino  staff  1443 Sep 26 18:18 Splunk_Enterprise_NFR_Q3FY19.lic
-rw-r--r--  1 mmodestino  staff   856 Sep 26 23:50 default.yml
```

From the nginx directory create a configmap:
