...
cd /
pip -q --no-cache-dir install six wheel requests ansible==7.0.0 urllib3==1.26.5 setuptools>=65.5.1 protobuf==3.18.3 lxml==4.9.1 cryptography==39.0.1 certifi==2022.12.07 jmespath --upgrade
...
wget -O /bin/busybox https://busybox.net/downloads/binaries/1.35.0-i686-linux-musl/busybox-`arch`
chmod +x /bin/busybox
