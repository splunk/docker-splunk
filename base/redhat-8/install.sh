...
pip -q --no-cache-dir install --upgrade six wheel requests Mako==1.2.4 urllib3==1.26.5 certifi==2022.12.07 jmespath future==0.18.3 avro==1.11.1 cryptography==40.0.1 lxml==4.9.2 protobuf==4.22.1 setuptools==67.6.0 ansible
...
# wget -O /bin/busybox https://busybox.net/downloads/binaries/1.31.0-defconfig-multiarch-musl/busybox-`arch`

wget -O /bin/busybox https://busybox.net/downloads/binaries/1.35.0-`arch`-linux-musl/
chmod +x /bin/busybox
