...
cd /
pip -q --no-cache-dir install six wheel requests ansible==7.0.0 avro==1.11.0 urllib3==1.26.5 setuptools>=65.5.1 protobuf==3.18.3 lxml==4.9.1 cryptography==39.0.1 certifi==2022.12.07 jmespath --upgrade
