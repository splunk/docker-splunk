...
run_tests_centos7:
	...
	pytest -n 2 -sv tests/test_splunk_image.py --platform centos-7 --junitxml test-results/centos7-result/testresults_centos7.xml
...
run_tests_redhat8:
	...
	pytest -n 2 -sv tests/test_splunk_image.py --platform redhat-8 --junitxml test-results/redhat8-result/testresults_redhat8.xml
...
run_tests_debian9:
	...
	pytest -n 2 -sv tests/test_splunk_image.py --platform debian-9 --junitxml test-results/debian9-result/testresults_debian9.xml

run_tests_debian10:
	@echo 'Running the super awesome tests; Debian 10'
	pytest -n 2 -sv tests/test_splunk_image.py --platform debian-10 --junitxml test-results/debian10-result/testresults_debian10.xml
