...
SCLOUD_URL ?= https://github.com/splunk/splunk-cloud-sdk-go/releases/download/v1.12.0-beta.7/scloud_v8.0.0-beta.7_linux_amd64.tar.gz
...
test_setup:
	...
	/usr/bin/python3.10 -m pip install --upgrade pip==23.0.1
